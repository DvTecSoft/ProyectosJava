...
public class Main {
	...
	public static void main(String[] args) 
	{
		...
		// Persona 1 usando constructor vacío
		...
		p1.setDV("7");
		p1.setRaza("L");		
		p1.setPerro(brako); // El nombre de la clase instanciada. Ahí setea el perro A o B
		
		// Obtener el perro de p1 
		System.out.println(p1.getPerro().getNombre())
		*/
		

		/* Se cae de esta fprma, al ejecutar los 2
		Perro dog1 = crearPerro();
		Perro dog2 = crearPerro();
		
		System.out.print(dog1.getNombre());
		System.out.print(dog2.getNombre());
		*/
